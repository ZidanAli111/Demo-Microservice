...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex,
		...
		ApiError err = new ApiError(HttpStatus.BAD_REQUEST, "Invalid JSON", details);
	...
	public ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		ApiError err = new ApiError(HttpStatus.BAD_REQUEST, "Malformed JSON request", details);
	...
	public ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ApiError err = new ApiError(HttpStatus.BAD_REQUEST, "Validation Errors", details);
	...
	public ResponseEntity<Object> handleMissingServletRequestParameter(MissingServletRequestParameterException ex,
		...
		ApiError err = new ApiError(HttpStatus.BAD_REQUEST, "Missing Parameters", details);
	...
	public ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex,
		...
		ApiError err = new ApiError(HttpStatus.BAD_REQUEST, "Mismatch Type", details);
	...
	public ResponseEntity<?> handleConstraintViolationException(Exception ex, WebRequest request) {
		...
		ApiError err = new ApiError(HttpStatus.BAD_REQUEST, "Constraint Violation", details);
	...
	public ResponseEntity<Object> handleResourceNotFoundException(ResourceNotFoundException ex) {
		...
		ApiError err = new ApiError(HttpStatus.NOT_FOUND, "Resource Not Found", details);
	...
	public ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		ApiError err = new ApiError(HttpStatus.BAD_REQUEST, "Method Not Found", details);
	...
	public ResponseEntity<Object> handleAll(Exception ex, WebRequest request) {
		...
		ApiError err = new ApiError(HttpStatus.BAD_REQUEST, "Error occurred", details);
